...
- **状态**: `[~]` 进行中(2026-07-07 立项;三线评估完成,用户定"降级收尾 + mana 双轨 + 天赋数值覆写"全做,~17 天)
...
| M7 核心机制层 + M6 降级补救 | `[~]` | M6 | 中高 | 5(M7a combat-hook-core/M7b combat-hook-rest/M7c targeting/M7d mana 双轨/M7e talent-override) | D6=(a) 天赋数值覆写 / D7=双轨 mana(不反转 D1);补 M6 降级(combat hook/stolen loot/targeting/Charm-Terror);summon sprite 永久降级(资产);评估见 §10 |
| **合计(M0-M6 完成 + M7 进行中)** | | | | **21 + M7 进行中** | M0-M6(21) + M7(5 进行中) |
