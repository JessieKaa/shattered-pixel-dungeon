...
| M9 集成测试与发布 | `[ ]` | M8 | 中 | 4(待细化:M9a/b/c/d) | save-slot×modding 交互 + 真机回归 + 平衡调参 + release 打包;fork 可交付 |
| M10 Remished 玩法补完 | `[ ]` | M9 | 中 | 3(待细化:M10a/b/c) | 全量 mob/buff/item/spell 移植 + room/painter API + buff 回调补完 |
| **合计(M0-M8 完成,M9-M10 立项)** | | | | **32 完成 + 7 立项** | M0-M8(32) + M9(4) + M10(3) 待做 |
