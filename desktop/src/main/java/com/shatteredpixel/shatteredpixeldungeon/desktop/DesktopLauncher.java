...
public class DesktopLauncher {
	...
	public static void main (String[] args) {
		...
		// M12b: register the desktop mod-zip picker so WndModManager shows its Import button.
		// Static holder, written once before the app starts; android registers its own in M12c.
		ModImporter.setPlatformImpl(new DesktopModImporter());
